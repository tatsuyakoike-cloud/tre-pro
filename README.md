...
| トレプロ営業方針改善計画 | [trepro_sales_improvement_plan.md](trepro_sales_improvement_plan.md) | [/tre-pro/trepro-lpk-sales-strategy/](https://tatsuyakoike-cloud.github.io/tre-pro/trepro-lpk-sales-strategy/) |
...
元資料は `trepro_sales_improvement_plan.md`。数値は `app/trepro-lpk-sales-strategy/data/metrics.json` を更新後、`main` に push すると GitHub Pages に反映されます。
