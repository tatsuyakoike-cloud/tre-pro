    ...
    <header className="sticky top-0 z-50 border-b border-stone-200/80 bg-white/90 backdrop-blur-md">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
        <div>
          ...
          <p className="text-sm font-bold text-stone-900">SlowBase 現状報告</p>
        </div>
        <a
          href="https://github.com/tatsuyakoike-cloud/tre-pro/blob/main/docs/slowbase-status-report.md"
          target="_blank"
          rel="noreferrer"
...
export default function SlowBaseStatusReportPage() {
  return (
        ...
        <article className="min-w-0 flex-1 space-y-16 sm:space-y-20">
          ...
          <section id="status" className="scroll-mt-24">
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="rounded-2xl border border-emerald-100 bg-emerald-50/40 p-6">
                ...
                <Prose>
                  <p>
                    現実的なヒントとして見たいのが、今すでに動いている既存顧客の支援です。
                    その中の一つが、餅田農園の SERAMADE。すでに以下の支援を行っています。
                  </p>
                </Prose>
                <BulletList items={clientSupport} />
          ...
          <section id="simulation" className="scroll-mt-24">
            <SectionHeading
              ...
              kicker="REVENUE"
              title="4. 売上シミュレーション"
              description="SERAMADEドリンク1本4,000円。月1回イベント（年12回）の試算。"
            />
            <DataTable
          ...
          <section id="slowbase-view" className="scroll-mt-24">
            <SectionHeading
              id="slowbase-view-heading"
              kicker="SLOWBASE"
              title="8. SlowBaseとして見たいこと"
            />
            <BulletList items={slowbaseFocus} />
            <p className="mt-4 text-sm leading-7 text-stone-600">
              結果が出れば、SlowBaseとして既存顧客に対する支援価値を見せやすくなり、将来的に以下の費用をいただく流れも作りやすくなります。
            </p>
          ...
          <section id="next" className="scroll-mt-24">
            ...
            <p className="mt-4 text-sm leading-7 text-stone-600">
              この2回で、既存顧客の商品がイベント経由で売上につながるかを見ます。
            </p>
          </section>
          ...
          <section id="summary" className="scroll-mt-24">
            ...
            <div className="mt-6 rounded-2xl border border-emerald-200 bg-gradient-to-br from-emerald-700 to-emerald-900 p-6 text-white sm:p-8">
              ...
              <p className="mt-6 text-sm font-bold leading-8 text-lime-200">
                既存顧客の売上を上げる → 支援価値を見せる → 販促・SNS・EC・月次改善支援として費用をいただける。
